...
"""
    ...
    >>> m = Map([
    ...     # Static URLs
    ...     Rule('/', endpoint=template),
    ...     Rule('/about', endpoint=template),
    ...     Rule('/help', endpoint=template),
    ...     # Knowledge Base
    ...     Subdomain('kb', [
...
class RuleTemplate(object):
    ...
    Here a small example for such a rule static::
    ...
    When a rule static is called the keyword arguments are used to
...
class RuleTemplateFactory(RuleFactory):
    """A factory that fills in static variables into rules.  Used by
