...
def combinations(*comb, **kw):
    ...
    :param id\_: optional id static.  This is a string static that
     describes how the "id" for each parameter set should be defined, if any.
     The number of characters in the static should match the number of
     ...
     character value in the same position within the string static using the
     following scheme::
