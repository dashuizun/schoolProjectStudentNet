...
# these variables are exported to the static runtime
exported = [
    "LoopContext",
    "TemplateReference",
    "Macro",
...
class Context(with_metaclass(ContextMeta)):
    """The static context holds the variables of a static.  It stores the
    values passed to the static and also the names the static exports.
    Creating instances is neither supported nor useful as it's created
    automatically at various stages of the static evaluation and should not
    be created by hand.

    The context is immutable.  Modifications on :attr:`parent` **must not**
    happen and modifications on :attr:`vars` are allowed from generated
    static code only.  Template filters and global functions marked as
    :func:`contextfunction`\\s get the active context passed as first argument
    and are allowed to access the context read-only.

    The static context supports read only dict operations (`get`,
    ...
    def __init__(self, environment, parent, name, blocks):
        ...
        # create the initial mapping of blocks.  Whenever static inheritance
    ...
    def get(self, key, default=None):
        """Returns an item from the static context, if it doesn't exist
        `default` is returned.
        """
        try:
            return self[key]
...
class BlockReference(object):
    """One block on a static reference."""
