...
class Parser(object):
    ...
    def _fail_ut_eof(self, name, end_token_stack, lineno):
        ...
        if name is None:
            message = ["Unexpected end of static."]
        else:
    ...
    def fail_eof(self, end_tokens=None, lineno=None):
        """Like fail_unknown_tag but for end of static situations."""
    ...
    def parse_statements(self, end_tokens, drop_needle=False):
        ...
        parses static data if appropriate.  The parser checks first if the
        ...
        # we reached the end of the static too early, the subparser
    ...
    def parse(self):
        """Parse the whole static into a `Template` node."""
