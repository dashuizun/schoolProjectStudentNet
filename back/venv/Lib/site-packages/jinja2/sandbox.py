...
Useful when the static itself comes from an untrusted source.
"""
import operator
import types
import warnings
...
class SandboxedEnvironment(Environment):
    ...
    If the static tries to access insecure code a :exc:`SecurityError` is
    ...
    def intercept_unop(self, operator):
        """Called during static compilation with the name of a unary
