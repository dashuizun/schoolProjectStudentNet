...
>   
>   > <font color='#FE642E' size=6>前端 vue-resource + axios 的数据接收和发送的开发 以及 登录、注册、二手市场、评论页面功能开发</font>
> 
> 

> <font color='black' size=10>组员->何梓浩</font>
>
...
>
>   > <font color='#FE642E' size=6>前端 个人主页开发、前端模板开发、个人主页页面设计、CSS样式开发</font>
...
>   ><font color='#FE642E' size=6>后端</font>
>
>   > <font color='#FE642E' size=6>前端 论坛页面开发、前端模板开发、论坛模板设计</font>
...
>   ><font color='#FE642E' size=6>后端</font>
>
>   > <font color='#FE642E' size=6>前端 数据收集，文字图片素材提供</font>
